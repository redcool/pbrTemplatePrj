Shader "FX/Box/BoxFog"
{
    Properties
    {
        ...
        [Group(Fog)]
        [GroupItem(Fog)] _FogColor("_FogColor",color) = (0.5,0.5,0.5,1)

        [GroupVectorSlider(Fog,heightDensity heightFall depthDensity depthFall,0_1 0_1 0_1 0_1, density and falloff,field)] _FogDensityFalloff("_FogDensityFalloff",vector) = (1,10,1,100)
        [GroupVectorSlider(Fog,depthMin depthMax heightMin,0_1 0_1 0_1,start dist,field)] _FogStartDist("_FogStartDist",vector) = (10,20,10,20)
...
// ================================================== stencil settings
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../../../PowerShaderLib/Lib/ExpFogLib.hlsl"
            ...
            half4 _FogDensityFalloff;
            half4 _FogStartDist;

            half4 _HeightMaxColor,_HeightMinColor,_DepthMaxColor,_FogColor;
            CBUFFER_END
